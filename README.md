...
2. [Part 1](#part-1-общие-требования) 
3. [Part 2](#part-2-дополнительно-настройки) 
4. [Part 3](#part-3-дополнительно-запись)     

## Introduction

В данном проекте требовалось реализовать на языке Си программу для просмотра 3D моделей в каркасном виде (3D Viewer). Сами модели необходимо загружать из файлов формата .obj и иметь возможность просматривать их на экране с возможностью вращения, масштабирования и перемещения.

В данном проекте было достаточно реализовать поддержку списка вершин и поверхностей. Все остальное - не является обязательным.

## Part 1. Общие требования
...
Copyright © 2023 Waresher, Ossiferk.